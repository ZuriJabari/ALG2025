        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div class="max-w-3xl">
                ...
                <div class="mt-8 flex flex-wrap items-center gap-3"
                    ...
                    <button type="button" @click="openToggle()" :aria-expanded="open.toString()" class="shrink-0 whitespace-nowrap inline-flex items-center gap-2 h-12 px-6 rounded-full border-2 border-teal-600 dark:border-teal-400 text-teal-700 dark:text-teal-300 hover:bg-teal-50/50 dark:hover:bg-slate-900/50 transition">Get updates</button>
