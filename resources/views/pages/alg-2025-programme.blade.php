              ...
              <div class="relative bg-white dark:bg-slate-950">
                <div class="px-4 sm:px-6 py-5 sm:py-6">
                  <ol class="space-y-0 text-sm sm:text-[15px] text-gray-800 dark:text-gray-100">
                    <li class="group flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4 px-3 sm:px-4 py-4 sm:py-5 odd:bg-white odd:dark:bg-slate-950 even:bg-teal-50 even:dark:bg-slate-800/80 border-t border-gray-200/60 dark:border-slate-700/60 first:border-t-0 transition-all duration-200 hover:bg-teal-100/70 dark:hover:bg-slate-700/90">
