<header data-header-version="v4" class="sticky top-0 z-50 bg-white/90 dark:bg-slate-950/90 backdrop-blur transition-all duration-300 supports-[backdrop-filter]:backdrop-saturate-150 relative overflow-hidden" x-data="{ mobileMenuOpen: false }">
    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 sm:py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-2 sm:gap-4">
            ...
            <!-- Mobile Menu Button -->
            <button data-mobile-toggle class="md:hidden p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800 transition-colors" @click.stop="console.log('toggle clicked, before:', mobileMenuOpen); mobileMenuOpen = !mobileMenuOpen; console.log('toggle clicked, after:', mobileMenuOpen)" :aria-expanded="mobileMenuOpen.toString()">
