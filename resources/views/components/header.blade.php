<header class="sticky top-0 z-50 bg-white/90 dark:bg-slate-950/90 backdrop-blur transition-all duration-300 supports-[backdrop-filter]:backdrop-saturate-150">
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between">
        <!-- Logo -->
        <a href="/" class="flex items-center gap-2 group">
            <img src="/assets/logo.png" alt="ALG" class="h-10 w-auto transition-transform group-hover:scale-105 dark:hidden">
            <img src="/assets/dark-logo.png" alt="ALG" class="h-10 w-auto transition-transform group-hover:scale-105 hidden dark:block">
        </a>
        ...
        <div class="flex items-center gap-4">
            ...
            <!-- CTA Button -->
            <a href="#register" class="hidden sm:inline-flex px-6 py-2 bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 text-white font-semibold rounded-full transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0 shadow-lg hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-500/40">
                Reserve your seat
            </a>

            <!-- Mobile Menu Button -->
            <button class="md:hidden p-2 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-slate-800">
