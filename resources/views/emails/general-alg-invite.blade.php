...
<body>
  <div class="container">
    ...
    <h1 style="margin-top:16px; font-size:24px; font-weight:600; color:#0F766E;">IMPORTANT: Announcing the Full #ALG2025 Agenda</h1>
    ...
    <div class="card" style="margin-top:16px; padding:20px 22px;">
      ...
      <div style="margin-top:18px; padding:14px 16px; border-radius:14px; background:#F0FDFA; border:1px solid #CCFBF1;">
        ...
        <ul style="margin:8px 0 0 18px; padding:0; font-size:14px; line-height:1.7; color:#4B5563;">
          ...
          <li>📺 Live streaming available on YouTube: <a href="https://alg.nsl.ug/youtube" target="_blank" rel="noopener">https://alg.nsl.ug/youtube</a></li>
        </ul>
      </div>
